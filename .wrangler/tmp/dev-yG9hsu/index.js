...
__name(handleEcho, "handleEcho");

// src/handlers/root.js
function handleRoot() {
  return json({
...
var src_default = {
  async fetch(request, env, ctx) {
    ...
    const route = routes.find(
      ({ method, pathname }) => request.method === method && url.pathname === pathname
    );
    if (route) {
...
// .wrangler/tmp/bundle-lR84oO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-lR84oO/middleware-loader.entry.ts
